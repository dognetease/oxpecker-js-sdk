...
class Text extends React.Component {
  ...
  onColorChange(e) {
    let value = 'rgba(' + e.r + ',' + e.g + ',' + e.b + ',' + e.a + ')';
        ...
        <div className="i-line clearfix">
          ...
          <div className="right">
            <Radio.Group onChange={ e => this.onAlignChange(e) } value={ align } getPopupContainer={trigger => trigger.parentNode}>
              <Radio.Button value="left"><i className="demo-icon icon-align-left" style={{marginLeft:"-2px"}}></i></Radio.Button>
              <Radio.Button value="center"><i className="demo-icon icon-align-center" style={{marginLeft:"-2px"}}></i></Radio.Button>
              <Radio.Button value="right"><i className="demo-icon icon-align-right" style={{marginLeft:"-2px"}}></i></Radio.Button>
              <Radio.Button value="justify"><i className="demo-icon icon-align-justify"></i></Radio.Button>
            </Radio.Group>
          </div>
        </div>
      </div>
