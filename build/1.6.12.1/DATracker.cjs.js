...
var heatmap = {
   ...
   */
  start: function (ev, target, noPath, tagName) {
    ...
    if ((target.tagName.toLowerCase() === 'a' || tagName === 'a') && heatmapConfig && heatmapConfig.isTrackLink === true) {
  ...
  initHeatmap: function () {
    ...
    _.addEvent(document, 'click', function (e) {
      ...
      if (isA || ['button', 'input', 'textarea'].indexOf(tagName) > -1) {
        ...
        that.start(ev, target, '', isA.tagName.toLowerCase());
